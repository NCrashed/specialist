...
\addcontentsline{toc}{section}{Приложение Б. Описание языка формализованных запросов}
\includepdf[pages=-]{sphinx.pdf}

\newpage
\addcontentsline{toc}{section}{Приложение В. Графическая часть}
\includepdf[pages=-]{lists_title.pdf}
\includepdf[pages=-,landscape=true]{lists.pdf}
